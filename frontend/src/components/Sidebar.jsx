    ...
    <aside className="w-60 bg-slate-900 border-r border-slate-800 flex flex-col flex-shrink-0">
      <div className="p-5 border-b border-slate-800">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-lg font-bold text-white tracking-tight">Actify</span>
        </div>
        <p className="text-xs text-slate-600 mt-1 ml-0.5">Automation Control Room</p>
      </div>
      ...
      <div className="p-4 border-t border-slate-800">
        <p className="text-xs text-slate-700 text-center">v1.0 Starter</p>
      </div>
    </aside>
  );
}